...
public class HorizontalRecAdapter extends RecyclerView.Adapter<HorizontalRecAdapter.ViewHolder> {
    ...
    public HorizontalRecAdapter(List<HorizontalScrollModel> horizontalScrollModelList) {
        this.horizontalScrollModelList = horizontalScrollModelList;
    }

    @NonNull
    @Override
    public HorizontalRecAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HorizontalRecAdapter.ViewHolder viewHolder, int position) {
